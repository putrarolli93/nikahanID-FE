// src/pages/GardenInvitationPage.jsx
...
export default function GardenInvitationPage() {
  ...
  if (invitation.template_slug !== "garden") {
    return <div className="error-container" style={{display:'flex',justifyContent:'center',alignItems:'center',height:'100vh',background:'#f1f5f3',color:'#2c4033'}}><p>Akses ditolak: Undangan ini menggunakan template {invitation.template_name}, bukan Garden.</p></div>;
  }
  ...
  const mappedData = {
    ...
    venue: {
      name: scheduleAkad.event_address || "Taman Bunga Nusantara",
      address: scheduleAkad.event_address || "Cianjur, Jawa Barat",
